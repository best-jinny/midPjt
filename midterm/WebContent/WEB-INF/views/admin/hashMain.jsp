...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/midterm/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/midterm/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-1000 p-b-30">
				...
				<div class="container-login100-form-btn">
					<button onclick="location.href='/midterm/admin/hashtagList.do'" class="login100-form-btn">
						해시태그관리
					</button>
				</div>
				<br>
				<div class="container-login100-form-btn">
					<button onclick="location.href='/midterm/admin/hashKindList.do'" class="login100-form-btn">
						해시그룹관리
					</button>
				</div>
				<br>
				<div class="container-login100-form-btn">
					<button onclick="location.href='/midterm/admin/adminMain.do'" class="login100-form-btn">
						관리자메인
					</button>
				</div>
			</div>
