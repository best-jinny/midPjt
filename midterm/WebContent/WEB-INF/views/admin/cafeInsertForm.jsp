...
<body>
	<div class="limiter">
		<div class="container-login100">
			...
			<form action="/midterm/admin/cafeInsert.do" method="post" enctype="multipart/form-data" name="frm" id="frmId">
				...
				<div class="wrap-input100 validate-input m-b-13" data-validate = "Username is required">
					<input class="input100" type="text" name="cafe_name" required="required" autofocus="autofocus">
				...
				<div class="wrap-input100 validate-input m-b-13" data-validate = "Username is required">
					<textarea rows="10" class="input100" name="cafe_desc"></textarea>
					<span class="focus-input100"></span>
				</div>
				<span class="txt1 p-b-11">
					카페전화번호
				...
				<div class="wrap-input100 validate-input m-b-13" data-validate = "Username is required">
					<input class="input100" type="text" name="cafe_tel" >
					<span class="focus-input100"></span>
				</div>
				<span class="txt1 p-b-11">
					카페주소 (필수)
				...
				<div class="wrap-input100 validate-input m-b-13" data-validate = "Username is required">
					<input class="input100" id="cafe_addr" name="cafe_addr" placeholder="주소검색 눌러서 선택해주세요" required="required">
					<span class="focus-input100"></span>
				</div>
				<span class="txt1 p-b-11">
					카페지도좌표 (필수)
				...
				<div class="wrap-input100 validate-input m-b-13" data-validate = "Username is required">
					<input class="input100" type="text" name="cafe_map" id="cafe_map" placeholder="주소검색 눌러서 선택해주세요" required="required">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate = "Username is required">
					<input class="input100" type="text" name="cafe_hours" >
					<span class="focus-input100"></span>
				</div>
				<div id="imageLoad">
					<span class="txt1 p-b-11">
				...
				<span class="txt1 p-b-11">
					카페해시태그목록 <input type="button" value="목록비우기" onclick="emptyHashList()">
				</span>
				<div class="wrap-input100 validate-input m-b-20" data-validate = "Username is required">
				...
				<hr>
				<div class="container-login100-form-btn">
					<input type="submit" value="카페등록" class="login100-form-btn">
				</div>
				<br>
				<div class="container-login100-form-btn">
