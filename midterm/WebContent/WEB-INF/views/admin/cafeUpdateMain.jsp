		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-1000 p-b-30">
				...
				<div class="container-login100-form-btn">
					<button onclick="location.href='/midterm/admin/cafeInsertForm.do'" class="login100-form-btn">
						카페등록
					</button>
				</div>
				<br>
				<div class="container-login100-form-btn">
					<button onclick="location.href='/midterm/admin/cafeList.do'" class="login100-form-btn">
						수정/삭제
					</button>
				</div>
				<br>
