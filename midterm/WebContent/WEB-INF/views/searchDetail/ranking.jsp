...
<script type="text/javascript">
	function favorite(num) {
		...
		$.post("/midterm/search/wish.do", sendData);
		return false;
	}
</script>
</head>
						...
						<div class="listings_content">
							...
							<div id="searchResult">
								...
								<div class="results_container">
									<div class="section_title"><h1>The hot-teas right now <img class="listing_icon_emoji" src="/midterm/images/kermitBack.jpg" alt=""></h1></div>
											...
											<div class="grid-item result">
												<div class="listing">
													<div class="listing_image">
														<div class="listing_icon"><a href="listing.html"><img src="/midterm/images/fire.jpg" alt=""></a></div>
														<img src="${cafeImg }" alt="">
													</div>
															...
															<c:forEach var="cafehash" items="${cafe_hash }">
																<c:if test="${cafehash.key==cafe.cafe_id }">
																	...
																	<c:forEach var="hashtag" items="${cafehash.value }">
																		<div class="listing_type"><a href="/midterm/search/search.do?subject=${hashtag }">#${hashtag}</a></div>
																	<div class="listing_divider">|</div>
																	</c:forEach>
																</c:if>
															</c:forEach>
