...
<body>
<c:set var="originalOrder" value="${originalOrder }"></c:set>
<div class="container">
	<div class="row">			
		<!-- Listings Content -->
		<div class="col-xl-6">
			<div class="listings_content">
				...
				<div class="results_container">
					<div class="section_title"><h1>${subject}<span>에 관한 검색 결과입니다 </span></h1>
					<form name=orderForm>
						<select name="order">
							<c:if test="${originalOrder=='new'}">
								<option value="rel">관련도순</option>
								<option value="new" selected="selected">신상순</option>
								<option value="hot">인기순</option>
							</c:if>
							<c:if test="${originalOrder=='hot'}">
								<option value="rel">관련도순</option>
								<option value="new">신상순</option>
								<option value="hot" selected="selected">인기순</option>
							</c:if>
							<c:if test="${originalOrder=='rel'}">
								<option value="rel">관련도순</option>
								<option value="new">신상순</option>
								<option value="hot">인기순</option>
							</c:if>
						...
						<div class="grid-item result ${cafe_filter[cafe.cafe_id]}">
							<div class="listing">
								...
								<div class="listing_title_container">
									<div class="listing_title"><a href="/midterm/searchDetail/cafeDetail.do?member_id=${member_id }&cafe_id=${cafe.cafe_id }">${cafe.cafe_name }</a></div>
				...
				<div class="map">
					<div class="map_container">
						...
						for (var i=0;i<titles.length;i++) {
							...
							positions.push({title:titles[i],latlng:new kakao.maps.LatLng(coord1,coord2)});
						}
